...
**Update, later the same day:** LIFT 1.5 finishes the Train tab story this
post opens with — Android searches the same 873 exercises the browser and the
iPhone app do. [That one is its own post](/2026/09/14/lift-1-5.html).
